...
*/
void WG_Help_Page::onInit(SDL_Renderer* renderer, Audio* sounds,int w, int h, int* ascreen)
{
    ...
    title0.Init( renderer, "help", path + "future.ttf", 48, titleColor);
    ...
    startGameButton.addText("help me", path + "future.ttf", white, bf);
...
bool WG_Help_Page::onRender(void)
{
    bgImage.Render();
    title0.Render();
...
void WG_Help_Page::onEvent(SDL_Event event)
{
...
void WG_Help_Page::onLoop(void)
{};

void WG_Help_Page::onCleanup(void)
{};
